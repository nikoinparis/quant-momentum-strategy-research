...
def main():
    ...
    rows = [
        summarize_strategy("Momentum (20d)", mom_res.strategy_log_returns, mom_res.equity_curve),
        summarize_strategy("Mean Reversion (z)", mr_res.strategy_log_returns, mr_res.equity_curve),
    ]
