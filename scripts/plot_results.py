...
from src.plotting import plot_equity_curves, plot_drawdowns
...
def main():
    ...
    plot_equity_curves(
        {
            "Momentum (20d)": mom_res.equity_curve,
            "Mean Reversion (z)": mr_res.equity_curve,
        },
        title="SPY Strategy Equity Curves",
    )
